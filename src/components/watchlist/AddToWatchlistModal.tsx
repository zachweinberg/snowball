    ...
    <Modal isOpen={open} onClose={onClose}>
      <div className="relative h-96 w-96">
        ...
        >
          ...
          <p className="text-[1.25rem] font-bold text-center text-dark mb-11 leading-snug">
        ...
        >
          ...
          <form autoComplete="off" className="overflow-scroll">
            <TextInputWithResults placeholder="Enter symbol" type={assetType} />
          </form>
        </Transition>
      </div>
    </Modal>
