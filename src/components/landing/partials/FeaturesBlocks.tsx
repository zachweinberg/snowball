      ...
      <div className="relative max-w-6xl px-4 mx-auto sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl pb-12 mx-auto text-center md:pb-20">
            <h2 className="mb-4 h2">The Asset Classes</h2>
            <p className="text-xl text-gray-600">
              We believe core portfolios are made up of give asset classes. Contact us if you'd
              like to see more added!
            </p>
          </div>
          ...
          <div className="grid items-start max-w-sm gap-6 mx-auto md:grid-cols-2 lg:grid-cols-3 md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="mb-1 text-xl font-bold leading-snug tracking-tight">Stocks</h4>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="mb-1 text-xl font-bold leading-snug tracking-tight">Cash</h4>
              <p className="text-center text-gray-600">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-center text-gray-600">
                Own something that doesn't fall into one of the other asset classes? NFT's,
                cars, watches, you name it. Add whatever you'd like!
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="mb-1 text-xl font-bold leading-snug tracking-tight">And more?</h4>
              <p className="text-center text-gray-600">
                We are always open to feedback and improving Obsidian Tracker. Contact us if
                you believe another asset class should be available!
              </p>
            </div>
          </div>
        </div>
