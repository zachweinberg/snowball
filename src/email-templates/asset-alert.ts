...
const html = layout(`
        <mj-text font-weight="500" font-size="17px">Your alert has triggered!</mj-text>
        <mj-text font-size="15px">Hi there, your alert for <strong>{{ symbol }}</strong> is {{ direction }} your price target of {{ priceStr }}.</mj-text>
        <mj-text font-size="15px">This alert has now been removed from your alert list.</mj-text>
        <mj-text font-size="15px">Click <a href="https://obsidiantracker.com/alerts">here</a> to view your existing asset alerts.</mj-text>
