import { WatchListItem } from '@zachweinberg/wealth-schema';
      ...
      <div className="flex justify-between">
        <div className="flex-1 px-5 py-4 mr-10 bg-white border shadow-sm rounded-3xl border-bordergray">
          ...
          <div className="flex flex-col items-center justify-center p-32 text-center">
            ...
            <p className="font-medium text-[1rem] text-darkgray leading-tight">
              Search for a stock or crypto in the upper right hand corner to add your first
              asset to your watchlist.
            </p>
          </div>
        </div>
