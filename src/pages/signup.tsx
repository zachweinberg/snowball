  ...
  return (
    <RequiredLoggedOut>
      <div className="max-w-lg p-8 mx-auto mt-20 bg-white shadow-md rounded-2xl">
        ...
        <div className="mb-5">
          <TextInput name="name" placeholder="Your name" type="text" className="mb-4" />
          <TextInput name="email" placeholder="Email address" type="email" className="mb-4" />
          <TextInput name="password" placeholder="Password" type="password" className="mb-4" />
          <TextInput name="confirmPassword" placeholder="Confirm password" type="password" />
        </div>
