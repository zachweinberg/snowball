                ...
                <div className="space-y-6">
                  ...
                  <div className="flex justify-end">
                    <button
                      ...
                      type="button"
                      className="px-4 py-2 text-sm font-medium text-white border border-gray-300 rounded-md shadow-sm bg-red hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500"
                    >
                      Delete Portfolio
                    </button>
                    <button
