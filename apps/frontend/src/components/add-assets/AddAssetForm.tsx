...
const AddAssetForm: React.FunctionComponent<AddAssetFormProps> = ({
  ...
  return (
    <div className="relative max-w-5xl mx-auto mt-10">
      ...
      >
        <h2 className="mb-8 font-bold text-[1.75rem] text-center">
        ...
        <p className="mb-10 font-medium text-center text-darkgray text-md">
          Which type of asset do you want to add to this portfolio?
        </p>
